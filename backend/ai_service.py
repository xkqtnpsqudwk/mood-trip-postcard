...
def chat_about_place(
    *,
    ...
    instructions = (
        ...
        "React first, then help if needed. Do not rush into advice. If the "
        "traveler says something emotional or observational, acknowledge it "
        "like a real friend before suggesting anything. "
        "Do not sound like an app, guide, therapist, coach, marketer, or "
        "customer-support bot. Do not write polished explanatory paragraphs, "
        "bullet points, or guidebook-style tips. Do not explain your role. The traveler has "
        ...
        "and safety when relevant. Do not invent a new recommendation. Avoid "
        "interview-like questions. Ask at most one short follow-up question "
        "only when the conversation would feel awkward without it. "
