...
def _create_places_table_sql(table_name: str = "places") -> str:
    column_sql = ",\n            ".join(
        f"{name} {definition}" for name, definition in PLACE_COLUMN_DEFS
    )
    return f"""
...
def _ensure_places_schema(cursor: sqlite3.Cursor) -> None:
    cursor.execute(_create_places_table_sql("places"))
    rows = cursor.execute("PRAGMA table_info(places)").fetchall()
    existing_columns = [row["name"] for row in rows]
    expected_columns = [name for name, _ in PLACE_COLUMN_DEFS]
    should_rebuild = (
        any(column in existing_columns for column in OBSOLETE_PLACE_COLUMNS)
        or any(column not in existing_columns for column in expected_columns)
    )
    if not should_rebuild:
        return

    cursor.execute(_create_places_table_sql("places_new"))
    copy_columns = [column for column in expected_columns if column in existing_columns]
    if copy_columns:
        column_sql = ", ".join(copy_columns)
        cursor.execute(
            f"INSERT INTO places_new ({column_sql}) "
            f"SELECT {column_sql} FROM places"
        )
...
# Recommendation seed data uses only the fields needed for the current product:
# place identity/copy, visit duration, preference tags, avoid tags, and the
# recommendation reason shown to the user. Emotion display is generated at
# request time and is not stored on places.
...
_PLACES = [
    ...
    },
    {
        ...
        "preference_tags": "walking,photo,exhibition,shopping,lively",
        "preference_tags_ko": "산책,사진,전시,쇼핑,활기찬",
    ...
    },
    {
        ...
        "type_ko": "역사적인 동네",
        "duration": "2_3h,half_day",
        "preference_tags": "shopping,exhibition,cafe,photo,lively",
        "preference_tags_ko": "쇼핑,전시,카페,사진,활기찬",
    ...
    },
    {
        ...
        "type_ko": "식료품 시장",
        "duration": "under_30min,1h",
        "preference_tags": "shopping,cafe,lively",
        "preference_tags_ko": "쇼핑,카페,활기찬",
        "avoid_tags": "crowded,long_wait",
        "avoid_tags_ko": "사람 많은 곳,긴 대기",
    ...
    },
    {
        ...
        "type_ko": "젊음의 거리",
        "duration": "2_3h,half_day",
        "preference_tags": "shopping,cafe,night_view,lively",
        "preference_tags_ko": "쇼핑,카페,야경,활기찬",
        "avoid_tags": "crowded,long_wait",
        "avoid_tags_ko": "사람 많은 곳,긴 대기",
    ...
    {
        "city": "Paris",
        "name": "Bibliotheque Sainte-Genevieve",
        "description": "A grand historic reading room near the Pantheon, quiet enough to make an ordinary afternoon feel ceremonial.",
        "description_ko": "팡테옹 근처의 웅장한 역사 도서관으로, 평범한 오후도 의식처럼 느껴질 만큼 조용한 열람실이 있어요.",
        "name_ko": "생트 주느비에브 도서관",
        "type": "Historic library",
        "type_ko": "역사 도서관",
        "duration": "1h,2_3h",
        "preference_tags": "reading,quiet,history,photo",
        "preference_tags_ko": "독서,조용한,역사 탐방,사진",
        "avoid_tags": "long_wait",
        "avoid_tags_ko": "긴 대기",
        "reason": "A historic reading room with long tables and iron arches, ideal when you want a calm indoor stop that still feels like Paris.",
        "reason_ko": "긴 책상과 철제 아치가 인상적인 역사 도서관으로, 조용한 실내에 머물면서도 파리다운 분위기를 느끼기 좋아요.",
    },
    {
        "city": "Paris",
        "name": "Bibliotheque Mazarine",
        "description": "France's oldest public library, tucked beside the Seine with a hushed scholarly atmosphere.",
        "description_ko": "센 강 옆에 자리한 프랑스에서 가장 오래된 공공 도서관으로, 차분한 학문적 분위기가 감돌아요.",
        "name_ko": "마자린 도서관",
        "type": "Historic library",
        "type_ko": "역사 도서관",
        "duration": "under_30min,1h",
        "preference_tags": "reading,quiet,history",
        "preference_tags_ko": "독서,조용한,역사 탐방",
        "avoid_tags": "",
        "avoid_tags_ko": "",
        "reason": "A compact, dignified library by the river, good for travelers who prefer quiet interiors over crowded landmarks.",
        "reason_ko": "강변에 자리한 작고 품위 있는 도서관으로, 붐비는 명소보다 조용한 실내를 좋아하는 여행자에게 잘 맞아요.",
    },
    {
        "city": "Paris",
        "name": "Cafe de Flore",
        "description": "A classic Saint-Germain cafe where writers, students, and travelers turn coffee into a small ritual.",
        "description_ko": "작가와 학생, 여행자들이 커피 한 잔을 작은 의식처럼 즐겨온 생제르맹의 클래식 카페예요.",
        "name_ko": "카페 드 플로르",
        "type": "Historic cafe",
        "type_ko": "역사적인 카페",
        "duration": "under_30min,1h",
        "preference_tags": "cafe,reading,photo,history",
        "preference_tags_ko": "카페,독서,사진,역사 탐방",
        "avoid_tags": "crowded,expensive",
        "avoid_tags_ko": "사람 많은 곳,비싼 곳",
        "reason": "A literary cafe with a strong sense of place, best when you want to sit, observe, and keep the trip slow for a while.",
        "reason_ko": "문학적인 분위기가 진한 카페라 잠시 앉아 사람들을 바라보고, 여행의 속도를 늦추고 싶을 때 좋아요.",
    },
    {
        "city": "Paris",
        "name": "Maison de Victor Hugo",
        "description": "A literary museum on Place des Vosges, intimate and quiet enough for a reflective indoor pause.",
        "description_ko": "보주 광장에 있는 빅토르 위고의 집으로, 조용히 머물며 사색하기 좋은 문학 박물관이에요.",
        "name_ko": "빅토르 위고의 집",
        "type": "Literary museum",
        "type_ko": "문학 박물관",
        "duration": "under_30min,1h",
        "preference_tags": "reading,history,exhibition,quiet",
        "preference_tags_ko": "독서,역사 탐방,전시,조용한",
        "avoid_tags": "",
        "avoid_tags_ko": "",
        "reason": "A small literary museum that pairs well with a quiet square walk, good for travelers drawn to books and old rooms.",
        "reason_ko": "조용한 광장 산책과 함께 들르기 좋은 작은 문학 박물관으로, 책과 오래된 방의 분위기를 좋아한다면 잘 맞아요.",
    },
    {
        "city": "Paris",
        "name": "Merci Used Book Cafe",
        "description": "A warm book cafe inside a concept store, with used books, coffee, and a casual Marais rhythm.",
        "description_ko": "중고책과 커피, 마레 지구의 느슨한 분위기가 섞인 콘셉트 스토어 안의 북카페예요.",
        "name_ko": "메르시 유즈드 북 카페",
        "type": "Book cafe",
        "type_ko": "북카페",
        "duration": "1h,2_3h",
        "preference_tags": "cafe,reading,shopping,photo",
        "preference_tags_ko": "카페,독서,쇼핑,사진",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A book cafe where browsing and resting overlap, useful when you want a soft indoor break without leaving the neighborhood mood.",
        "reason_ko": "책 구경과 휴식이 자연스럽게 겹치는 북카페로, 동네의 분위기를 유지한 채 실내에서 쉬고 싶을 때 좋아요.",
    },
    {
        "city": "Paris",
        "name": "Bibliotheque Francois-Mitterrand",
        "description": "A vast modern library campus near the Seine, calm, geometric, and spacious around its wooden garden.",
        "description_ko": "센 강 근처의 거대한 현대 도서관으로, 나무 정원을 둘러싼 차분하고 넓은 공간감이 인상적이에요.",
        "name_ko": "프랑수아 미테랑 도서관",
        "type": "Modern library",
        "type_ko": "현대 도서관",
        "duration": "1h,2_3h",
        "preference_tags": "reading,quiet,riverside,photo",
        "preference_tags_ko": "독서,조용한,강변,사진",
        "avoid_tags": "far",
        "avoid_tags_ko": "너무 먼 곳",
        "reason": "A spacious modern library by the Seine, good for a quieter, less postcard-obvious version of Paris.",
        "reason_ko": "센 강 옆의 넓은 현대 도서관으로, 뻔한 풍경보다 조용하고 다른 결의 파리를 보고 싶을 때 좋아요.",
    },
    {
        "city": "Seoul",
        "name": "Starfield Library",
        "description": "A dramatic open library inside COEX, where towering bookshelves turn a shopping mall into a photo-worthy pause.",
        "description_ko": "코엑스 안에 있는 개방형 도서관으로, 높은 책장이 쇼핑몰 한가운데를 사진 찍기 좋은 쉼표로 바꿔줘요.",
        "name_ko": "별마당도서관",
        "type": "Open library",
        "type_ko": "개방형 도서관",
        "duration": "under_30min,1h",
        "preference_tags": "reading,photo,shopping",
        "preference_tags_ko": "독서,사진,쇼핑",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A visually striking library for a short indoor stop, especially good when you want books, photos, and easy access in one place.",
        "reason_ko": "책과 사진, 쉬운 접근성을 한 번에 원할 때 좋은 실내 정거장으로, 짧게 들러도 인상이 강해요.",
    },
    {
        "city": "Seoul",
        "name": "Seoul Book Bogo",
        "description": "A secondhand bookstore archive where curved shelves and old books make browsing feel like a quiet treasure hunt.",
        "description_ko": "곡선형 책장과 오래된 책들이 이어지는 중고서점 아카이브로, 조용한 보물찾기처럼 둘러보기 좋아요.",
        "name_ko": "서울책보고",
        "type": "Secondhand bookstore",
        "type_ko": "중고서점",
        "duration": "1h,2_3h",
        "preference_tags": "reading,quiet,shopping,photo",
        "preference_tags_ko": "독서,조용한,쇼핑,사진",
        "avoid_tags": "",
        "avoid_tags_ko": "",
        "reason": "A calm secondhand bookstore with enough visual character to feel like a destination, not just a shop.",
        "reason_ko": "조용히 책을 고르기 좋으면서 공간 자체의 인상도 강해, 단순한 상점보다 하나의 목적지처럼 느껴져요.",
    },
    {
        "city": "Seoul",
        "name": "Cheongun Literature Library",
        "description": "A hanok-style literature library near Inwangsan, quiet, wooden, and removed from the downtown rush.",
        "description_ko": "인왕산 근처의 한옥 문학도서관으로, 나무 결이 살아 있고 도심의 속도에서 한 걸음 떨어져 있어요.",
        "name_ko": "청운문학도서관",
        "type": "Literary library",
        "type_ko": "문학 도서관",
        "duration": "1h,2_3h",
        "preference_tags": "reading,quiet,history,walking",
        "preference_tags_ko": "독서,조용한,역사 탐방,산책",
        "avoid_tags": "far,complex_route",
        "avoid_tags_ko": "너무 먼 곳,복잡한 동선",
        "reason": "A hanok library that feels slow and sheltered, ideal when quiet reading matters more than checking off landmarks.",
        "reason_ko": "느리고 보호받는 느낌의 한옥 도서관이라, 명소를 찍는 것보다 조용히 읽고 쉬는 시간이 중요할 때 잘 맞아요.",
    },
    {
        "city": "Seoul",
        "name": "Onion Anguk",
        "description": "A hanok cafe near Bukchon where old rooflines, pastries, and morning light make a gentle stop.",
        "description_ko": "북촌 근처의 한옥 카페로, 오래된 지붕선과 빵, 아침빛이 부드러운 정거장을 만들어줘요.",
        "name_ko": "어니언 안국",
        "type": "Hanok cafe",
        "type_ko": "한옥 카페",
        "duration": "under_30min,1h",
        "preference_tags": "cafe,photo,history",
        "preference_tags_ko": "카페,사진,역사 탐방",
        "avoid_tags": "crowded,long_wait",
        "avoid_tags_ko": "사람 많은 곳,긴 대기",
        "reason": "A popular hanok cafe with strong atmosphere, good when you want a photogenic pause rather than a long itinerary.",
        "reason_ko": "분위기가 뚜렷한 인기 한옥 카페라, 긴 동선보다 사진과 휴식이 있는 짧은 쉼표를 원할 때 좋아요.",
    },
    {
        "city": "Seoul",
        "name": "Anthracite Hapjeong",
        "description": "A quiet industrial-style cafe in a former shoe factory, good for reading, coffee, and slow time alone.",
        "description_ko": "옛 신발 공장을 고친 조용한 카페로, 혼자 커피를 마시며 책을 읽고 천천히 머물기 좋아요.",
        "name_ko": "앤트러사이트 합정",
        "type": "Cafe",
        "type_ko": "카페",
        "duration": "1h,2_3h",
        "preference_tags": "cafe,reading,quiet",
        "preference_tags_ko": "카페,독서,조용한",
        "avoid_tags": "",
        "avoid_tags_ko": "",
        "reason": "A spacious cafe with an industrial mood, useful when the trip needs a quiet reset rather than another landmark.",
        "reason_ko": "산업적인 분위기의 넓은 카페로, 또 다른 명소보다 조용히 리셋할 시간이 필요할 때 잘 맞아요.",
    },
    {
        "city": "Seoul",
        "name": "Seoul Metropolitan Library",
        "description": "A civic library inside the old city hall building, close to Deoksugung and easy to pair with a quiet walk.",
        "description_ko": "옛 서울시청 건물 안의 도서관으로, 덕수궁과 가까워 조용한 산책과 함께 들르기 좋아요.",
        "name_ko": "서울도서관",
        "type": "Civic library",
        "type_ko": "공공 도서관",
        "duration": "under_30min,1h",
        ...
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A central library with historic architecture, good for folding a calm indoor pause into a downtown walk.",
        "reason_ko": "역사적인 건물 안에 있는 도심 도서관이라, 시내 산책 중 차분한 실내 휴식을 끼워 넣기 좋아요.",
    },
    {
        "city": "Paris",
        "name": "Rue Oberkampf",
        "description": "A nightlife street of small bars, music venues, and casual crowds that keeps the evening moving.",
        "description_ko": "작은 바와 공연장, 편안한 인파가 이어지는 밤거리로 저녁의 리듬을 계속 움직이게 해줘요.",
        "name_ko": "오베르캉프 거리",
        "type": "Nightlife street",
        "type_ko": "밤거리",
        "duration": "1h,2_3h",
        "preference_tags": "lively,cafe,night_view,walking",
        "preference_tags_ko": "활기찬,카페,야경,산책",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A casual nightlife street with enough music and movement to lift the mood without becoming a formal club night.",
        "reason_ko": "음악과 움직임이 있는 캐주얼한 밤거리라, 클럽까지는 부담스럽지만 기분을 띄우고 싶을 때 좋아요.",
    },
    {
        "city": "Paris",
        "name": "Rue Mouffetard",
        "description": "A lively Latin Quarter market street packed with food shops, terraces, and student energy.",
        "description_ko": "음식점과 테라스, 학생들의 에너지가 모이는 라탱 지구의 활기찬 시장 거리예요.",
        "name_ko": "무프타르 거리",
        "type": "Market street",
        "type_ko": "시장 거리",
        "duration": "1h,2_3h",
        "preference_tags": "lively,shopping,cafe,walking",
        "preference_tags_ko": "활기찬,쇼핑,카페,산책",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A food-heavy street with a bright everyday buzz, good when you want Paris to feel animated and close to the ground.",
        "reason_ko": "음식과 일상의 활기가 가까이 느껴지는 거리라, 파리를 생동감 있게 느끼고 싶을 때 잘 맞아요.",
    },
    {
        "city": "Paris",
        "name": "Rue de Lappe",
        "description": "A compact Bastille nightlife lane where music, lights, and busy terraces make the night feel immediate.",
        "description_ko": "바스티유 근처의 짧은 밤거리로, 음악과 조명, 북적이는 테라스가 밤의 에너지를 바로 느끼게 해줘요.",
        "name_ko": "라프 거리",
        "type": "Nightlife lane",
        "type_ko": "밤 골목",
        "duration": "under_30min,1h",
        "preference_tags": "lively,night_view,cafe",
        "preference_tags_ko": "활기찬,야경,카페",
        "avoid_tags": "crowded,too_touristy",
        "avoid_tags_ko": "사람 많은 곳,너무 관광지스러운 곳",
        "reason": "A dense, energetic lane for a short burst of night atmosphere rather than a long sightseeing stop.",
        "reason_ko": "오래 머무는 관광지라기보다 짧고 강하게 밤 분위기를 느끼기 좋은 활기 있는 골목이에요.",
    },
    {
        "city": "Paris",
        "name": "Ground Control",
        "description": "A playful food hall and cultural space with street food, pop-ups, music, and a loose festival mood.",
        "description_ko": "스트리트푸드와 팝업, 음악이 섞인 문화 공간으로 작은 축제 같은 느슨한 분위기가 있어요.",
        "name_ko": "그라운드 컨트롤",
        "type": "Food hall",
        "type_ko": "푸드홀",
        "duration": "1h,2_3h",
        "preference_tags": "lively,cafe,shopping,exhibition",
        "preference_tags_ko": "활기찬,카페,쇼핑,전시",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A flexible food-and-culture stop with a social pulse, useful when you want options and energy in one place.",
        "reason_ko": "먹거리와 문화, 사람들의 에너지가 한곳에 모이는 공간이라 선택지가 많고 신나는 분위기를 원할 때 좋아요.",
    },
    {
        "city": "Seoul",
        "name": "Euljiro Nogari Alley",
        "description": "A neon-lit alley of beer tables, grilled snacks, and after-work energy spilling into the street.",
        "description_ko": "맥주 테이블과 구운 안주, 퇴근 후의 에너지가 골목으로 흘러나오는 네온빛 거리예요.",
        "name_ko": "을지로 노가리골목",
        "type": "Night food alley",
        "type_ko": "밤 먹거리 골목",
        "duration": "1h,2_3h",
        "preference_tags": "lively,cafe,night_view,walking",
        "preference_tags_ko": "활기찬,카페,야경,산책",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A lively evening alley where noise, neon, and simple food make the city feel awake.",
        "reason_ko": "소리와 네온, 소박한 먹거리가 섞여 도시가 깨어 있는 느낌을 주는 활기찬 저녁 골목이에요.",
    },
    {
        "city": "Seoul",
        "name": "Itaewon World Food Street",
        "description": "A mixed, energetic street of international restaurants, music, and late-evening crowds.",
        "description_ko": "세계 음식점과 음악, 늦은 저녁의 인파가 섞이는 이국적이고 에너지 있는 거리예요.",
        "name_ko": "이태원 세계음식거리",
        "type": "International food street",
        "type_ko": "세계음식 거리",
        "duration": "1h,2_3h",
        "preference_tags": "lively,cafe,shopping,night_view",
        "preference_tags_ko": "활기찬,카페,쇼핑,야경",
        "avoid_tags": "crowded,expensive",
        "avoid_tags_ko": "사람 많은 곳,비싼 곳",
        "reason": "A high-energy food street for travelers who want Seoul to feel mixed, loud, and open-ended.",
        "reason_ko": "서울을 조금 더 섞이고 시끄럽고 열린 분위기로 느끼고 싶을 때 잘 맞는 에너지 높은 거리예요.",
    },
    {
        "city": "Seoul",
        "name": "Apgujeong Rodeo Street",
        "description": "A stylish district of fashion shops, dessert cafes, pop-up stores, and bright weekend energy.",
        "description_ko": "패션 매장과 디저트 카페, 팝업 스토어가 이어지는 세련되고 밝은 에너지의 거리예요.",
        "name_ko": "압구정 로데오거리",
        "type": "Fashion street",
        "type_ko": "패션 거리",
        "duration": "1h,2_3h",
        "preference_tags": "lively,shopping,cafe,photo",
        "preference_tags_ko": "활기찬,쇼핑,카페,사진",
        "avoid_tags": "crowded,expensive",
        "avoid_tags_ko": "사람 많은 곳,비싼 곳",
        "reason": "A polished, fast-moving district for shopping, people-watching, and a more glamorous kind of city energy.",
        "reason_ko": "쇼핑과 사람 구경, 조금 더 화려한 도시 에너지를 원할 때 어울리는 빠른 템포의 거리예요.",
    },
    {
        "city": "Seoul",
        "name": "Konkuk University Taste Street",
        "description": "A youthful food street full of casual restaurants, dessert shops, and late-night student energy.",
        "description_ko": "캐주얼한 음식점과 디저트 가게, 늦은 밤 학생들의 에너지가 이어지는 젊은 먹거리 거리예요.",
        "name_ko": "건대 맛의거리",
        "type": "Youth food street",
        "type_ko": "청춘 먹거리 거리",
        "duration": "1h,2_3h",
        "preference_tags": "lively,cafe,shopping,night_view",
        "preference_tags_ko": "활기찬,카페,쇼핑,야경",
        "avoid_tags": "crowded",
        "avoid_tags_ko": "사람 많은 곳",
        "reason": "A casual student-area street with food, lights, and movement, good when you want the trip to feel easy and upbeat.",
        "reason_ko": "먹거리와 조명, 움직임이 있는 학생가 거리라 여행을 가볍고 신나게 만들고 싶을 때 좋아요.",
    },
]
