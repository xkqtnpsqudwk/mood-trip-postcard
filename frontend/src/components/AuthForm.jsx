...
export default function AuthForm({ onSuccess }) {
  ...
  return (
    <form
      ...
      className="mx-auto w-full max-w-md rounded-3xl bg-white/70 p-6 shadow-[0_25px_60px_-15px_rgba(244,114,182,0.4)] ring-1 ring-white/60 backdrop-blur sm:p-8 dark:bg-zinc-900/60 dark:shadow-[0_0_40px_rgba(168,85,247,0.15)] dark:ring-fuchsia-500/20"
    >
